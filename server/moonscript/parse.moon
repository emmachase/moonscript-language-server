...
import trim, pos_to_line, pos_to_line_column, get_line from require "moonscript.util"
...

  {
    ...
    match_raw: (str) =>
      ...
      unless tree
        ...
        line, col = re.calcline str, errpos
        -- msg = "Error at line #{line} (col #{col}):"
        -- TODO
...

{
  ...
  string_raw: (str) -> file_parser!\match_raw str
}
